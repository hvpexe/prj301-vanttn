...
public class updateCartServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            HttpSession session = request.getSession(true); //session always not null
            
            HashMap<Plant, Integer> cart = (HashMap) session.getAttribute("cart");
            if (cart != null) {
                boolean found = cart.containsKey(plant);
                if (found) {
