...
public class Filter3 implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            //xu li request trc khi day no xuong tang servlet2
            request.setAttribute("tester", "testing");
            chain.doFilter(wrappedRequest, wrappedResponse);
            //xu li response cua servlet 2 tra ve
            PrintWriter out = wrappedResponse.getWriter();
            out.println("<h1>em yeu co </h1>");
            HttpServletRequest req = (HttpServletRequest)request; 
            out.println("tried to access " +   req.getRequestURL() +" on "); 
